...
namespace SFN.Socafan.API.Migrations
{
    ...
    partial class SFNDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SFN.Socafan.Common.Models.GamePlay", b =>
                {
                    b.Property<int>("IdGamePlay")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SFN.Socafan.Common.Models.Answer", b =>
                {
                    ...
                    b.HasOne("SFN.Socafan.Common.Models.GamePlay", "Game")
                        .WithMany("Answers")
                        .HasForeignKey("IdGamePlay")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
